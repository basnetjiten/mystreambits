...
class DonationgoalController extends Controller
{
    ...
    public function postHome(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'font_color' => [ 'required', 'regex:/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/' ],
            'bar_text_color' => [ 'required', 'regex:/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/' ],
            'bar_color' => [ 'required', 'regex:/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/' ],
            'bar_background_color' => [ 'required', 'regex:/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/' ],
